...
The annual replay-backed section is reconstructed from the regular multi-lane exact replay stack; it is not inserted into the tracked-position store and is not labeled as broker/live tracked fills.

- Generated: `2026-06-02T14:05:32Z`
- Replayed rows: `112`
- Unresolved rows: `0`
