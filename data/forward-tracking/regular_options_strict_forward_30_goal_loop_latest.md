...
- Next window trade date: `2026-07-06`.
- Next window start ET: `2026-07-06T09:30:00-04:00`.
- Safe no-append collection command: `npm run options:goal-loop:strict-forward-30 -- --selection-date 2026-07-06 --market-window-confirmed --market-window-status open --run-scan-sweep --json`.
