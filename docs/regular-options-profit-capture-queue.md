...
- Selection readiness: `{"blocked_guardrail_only": 5, "do_not_chase": 173, "paper_review_candidate": 15, "watch_repair_only": 82}`.
...
- Fresh scan matches: `5` with decisions `{"blocked": 5}`.
- Tier A fresh-match bridge: `0` with statuses `{"not_bridge_eligible": 5}`.
...
|---|---|---|---|---|---|---|---|---:|---:|---|---|
| blocked_but_interesting | blocked_guardrail_only | not_bridge_eligible | QQQ | volatility_expansion_observation | blocked | lane_signature | True | 40.24 | 53.4 | volatility_expansion_observation:needs-paper, volatility_expansion_observation_chain_native_put_timeexit_all_sleeves:needs-paper, volatility_expansion_call_timeexit_probe:quarantine_do_not_chase, volatility_expansion_observation_chain_native_call_timeexit_all_sleeves:quarantine_do_not_chase | Quality score 53.4 is below the Volatility Expansion Observation minimum of 70.0.; Lane profitability gate blocked candidate: lane_profitability_gate_report_stale. |
| blocked_but_interesting | blocked_guardrail_only | not_bridge_eligible | SPY | volatility_expansion_observation | blocked | lane_signature | True | 40.66 | 70.5 | volatility_expansion_observation:needs-paper, volatility_expansion_observation_chain_native_put_timeexit_all_sleeves:needs-paper, volatility_expansion_observation_chain_native_call_timeexit_all_sleeves:quarantine_do_not_chase, volatility_expansion_call_timeexit_probe:quarantine_do_not_chase | Lane profitability gate blocked candidate: lane_profitability_gate_report_stale. |
| blocked_but_interesting | blocked_guardrail_only | not_bridge_eligible | RIO | ai_commodity_infra_observation | blocked | no_symbol_sleeve | True | 41.48 | 57.7 |  | AI Commodity Infra has no trusted daily EOD option history loaded for RIO yet; treat this as discovery-only until Theta history is imported.; Quality score 57.7 is below the AI Commodity Infra minimum of 70.0.; Lane profitability gate blocked candidate: lane_profitability_gate_report_stale. |
| blocked_but_interesting | blocked_guardrail_only | not_bridge_eligible | FCX | ai_commodity_infra_observation | blocked | symbol_only | True | 28.14 | 70.0 | lane_a_chain_native_ret20_4_stop200_time75:quarantine_do_not_chase, regular_bearish_put_primary_chain_native_timeexit_all_sleeves:needs-paper, relative_strength_pullback_ex_clean_universe_v1:quarantine_do_not_chase, bullish_pullback_observation:quarantine_do_not_chase | Lane profitability gate blocked candidate: lane_profitability_gate_report_stale. |
| blocked_but_interesting | blocked_guardrail_only | not_bridge_eligible | IWM | volatility_expansion_observation | blocked | symbol_only | True | 43.47 | 44.0 | bullish_pullback_observation:tier_b_profitable_watch_repair, iwm_small_cap_risk:tier_b_profitable_watch_repair, sleeve_ticker_iwm:tier_b_profitable_watch_repair, sleeve_next_index_with_iwm_spy_control_v1:tier_b_profitable_watch_repair | Quality score 44.0 is below the Volatility Expansion Observation minimum of 70.0.; Lane profitability gate blocked candidate: lane_profitability_gate_report_stale. |
...
| quarantine_do_not_chase | do_not_chase | SPY | volatility_expansion_observation_chain_native_call_fast35_all_sleeves | rejected | 26 | 9 | 74.29 | 0.08 | -24.04 | -27.7 | none | {"blocked_count": 1, "bridge_blockers": ["guardrail_not_clear", "no_tier_a_lane_match"], "clear_count": 0, "fresh_executable_count": 1, "fresh_scan_match_count": 1, "guardrail_reasons": ["Lane profitability gate blocked candidate: lane_profitability_gate_report_stale."], "paper_shortlist_candidate_count": 0, "playbooks": ["volatility_expansion_observation"]} | adequate_negative_exact_intraday_evidence, quote_coverage_below_97_5, trading_desk_guardrail_negative_concentration |
| quarantine_do_not_chase | do_not_chase | QQQ | volatility_expansion_call_timeexit_probe | rejected | 26 | 4 | 86.67 | 0.71 | -8.3 | 8.59 | none | {"blocked_count": 1, "bridge_blockers": ["guardrail_not_clear", "no_tier_a_lane_match"], "clear_count": 0, "fresh_executable_count": 1, "fresh_scan_match_count": 1, "guardrail_reasons": ["Quality score 53.4 is below the Volatility Expansion Observation minimum of 70.0.", "Lane profitability gate blocked candidate: lane_profitability_gate_report_stale."], "paper_shortlist_candidate_count": 0, "playbooks": ["volatility_expansion_observation"]} | adequate_negative_exact_intraday_evidence, quote_coverage_below_97_5, trading_desk_guardrail_negative_concentration |
...
| quarantine_do_not_chase | do_not_chase | QQQ | volatility_expansion_observation_chain_native_call_timeexit_all_sleeves | rejected | 24 | 6 | 80.0 | 0.63 | -10.02 | -11.89 | none | {"blocked_count": 1, "bridge_blockers": ["guardrail_not_clear", "no_tier_a_lane_match"], "clear_count": 0, "fresh_executable_count": 1, "fresh_scan_match_count": 1, "guardrail_reasons": ["Quality score 53.4 is below the Volatility Expansion Observation minimum of 70.0.", "Lane profitability gate blocked candidate: lane_profitability_gate_report_stale."], "paper_shortlist_candidate_count": 0, "playbooks": ["volatility_expansion_observation"]} | adequate_negative_exact_intraday_evidence, quote_coverage_below_97_5, trading_desk_guardrail_negative_concentration |
...
| quarantine_do_not_chase | do_not_chase | QQQ | volatility_expansion_observation_chain_native_call_fast35_all_sleeves | rejected | 23 | 9 | 71.88 | 0.22 | -13.56 | -10.88 | none | {"blocked_count": 1, "bridge_blockers": ["guardrail_not_clear", "no_tier_a_lane_match"], "clear_count": 0, "fresh_executable_count": 1, "fresh_scan_match_count": 1, "guardrail_reasons": ["Quality score 53.4 is below the Volatility Expansion Observation minimum of 70.0.", "Lane profitability gate blocked candidate: lane_profitability_gate_report_stale."], "paper_shortlist_candidate_count": 0, "playbooks": ["volatility_expansion_observation"]} | adequate_negative_exact_intraday_evidence, quote_coverage_below_97_5, trading_desk_guardrail_negative_concentration |
...
| quarantine_do_not_chase | do_not_chase | SPY | volatility_expansion_call_timeexit_probe | rejected | 22 | 6 | 78.57 | 0.47 | -16.48 | -26.46 | none | {"blocked_count": 1, "bridge_blockers": ["guardrail_not_clear", "no_tier_a_lane_match"], "clear_count": 0, "fresh_executable_count": 1, "fresh_scan_match_count": 1, "guardrail_reasons": ["Lane profitability gate blocked candidate: lane_profitability_gate_report_stale."], "paper_shortlist_candidate_count": 0, "playbooks": ["volatility_expansion_observation"]} | adequate_negative_exact_intraday_evidence, quote_coverage_below_97_5, trading_desk_guardrail_negative_concentration |
...
| quarantine_do_not_chase | do_not_chase | SPY | tracked_winner_chain_native_qqq_time80_intraday | rejected | 20 | 29 | 40.82 | 0.62 | -18.15 | -46.8 | none |  | adequate_negative_exact_intraday_evidence, quote_coverage_below_97_5, trading_desk_guardrail_negative_concentration |
| quarantine_do_not_chase | do_not_chase | SPY | volatility_expansion_observation_chain_native_call_timeexit_all_sleeves | rejected | 20 | 8 | 71.43 | 0.44 | -14.96 | -10.18 | none | {"blocked_count": 1, "bridge_blockers": ["guardrail_not_clear", "no_tier_a_lane_match"], "clear_count": 0, "fresh_executable_count": 1, "fresh_scan_match_count": 1, "guardrail_reasons": ["Lane profitability gate blocked candidate: lane_profitability_gate_report_stale."], "paper_shortlist_candidate_count": 0, "playbooks": ["volatility_expansion_observation"]} | adequate_negative_exact_intraday_evidence, quote_coverage_below_97_5, trading_desk_guardrail_negative_concentration |
...
| regular_guardrail_starvation | ok | 2026-06-16T17:04:38Z | data/forward-tracking/regular_guardrail_starvation_latest.json |
