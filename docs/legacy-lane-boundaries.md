...
| `day_trading` | `paused_out_of_scope` | `not_mounted_browser_product` | `src/lib/day-trading`<br>`tests/day-trading`<br>`docs/day-trading-current-state.md`<br>`docs/archive/day-trading-product-roadmap.md` |
