...
- `docs/options-strategy-deep-research-recovery-2026-07-07.md`
  - recovered Claude deep-research artifact for options-strategy literature evidence, focused reviewer synthesis, and the read-only next-contract recommendation for `defined_risk_index_vrp_credit_spread_v1`
...
- `docs/regular-options-out-of-sample-frozen-filter-evaluation.md`
  - generated one-shot Phase 15.3 frozen-filter out-of-sample evaluation; current status is `out_of_sample_frozen_filter_parked` with verdict `park_filter_hypothesis_tracker_may_continue` over 29/29 evaluated months (percent/USD cluster PF LB `0.22`/`0.14`, net P&L `-18,210` USD)
- `docs/regular-options-refreeze-filter-family-design-packet-2026-07-05.md`
  - operator-activated design-only hypothesis family packet (F1 momentum-gate alignment, F2 session-time alignment, F3 deferred threshold-distance) under the refreeze/filter-family research contract; no evaluation, no window consumption
- `data/contracts/regular-options-filter-family-preregistration-draft-v1.json`
  - draft machine-readable F1a/F1b/F1c/F2 filter-family definitions grounded in the production pullback gate; design-only, evaluation blocked until a separate fresh-window contract and operator approval exist
- `data/contracts/regular-options-oos-known-source-gaps-v1.json`
  - pinned documented provider gaps for the OOS window (7 Alpaca NYSE minute-bar gaps on 2022-03-08) consumed by the input-surface tracker's `--known-source-gaps` readiness gate
- `docs/regular-options-out-of-sample-extension-underlying-daily-source-import.md`
  - generated tokened OOS-window underlying daily source import readback (7,033 point-in-time source rows, 2021-10-01 lookback through 2024-05-31)
- `docs/regular-options-out-of-sample-extension-direct-vix-source-import.md`
  - generated tokened OOS-window direct VIX source import readback (1,044 rows; OOS VIX bucket ready at 100% coverage)
- `docs/regular-options-out-of-sample-extension-earnings-calendar-source-import.md`
  - generated tokened OOS-window SEC Item 2.02 earnings source import readback (103 filings with EDGAR acceptance known-at)
- `docs/regular-options-out-of-sample-extension-alpaca-underlying-minute-price-surface-import.md`
  - generated tokened OOS-window Alpaca SIP underlying minute entry-surface import readback (558,591 rows, ET minutes 575–645)
- `docs/regular-options-out-of-sample-extension-point-in-time-market-regime-inputs.md`
  - generated OOS-window point-in-time market-regime inputs readback (ready, 29/29 months)
- `docs/regular-options-out-of-sample-extension-point-in-time-vix-bucket.md`
  - generated OOS-window point-in-time VIX bucket readback (ready, 100% coverage)
- `docs/regular-options-out-of-sample-extension-point-in-time-earnings-calendar.md`
  - generated OOS-window point-in-time earnings calendar readback (ready)
- `docs/regular-options-out-of-sample-extension-historical-scanner-input-surface-tracker.md`
  - generated OOS-window input-surface tracker readback; entry and option-chain surfaces ready with 7 documented source-gap pairs
- `docs/regular-options-out-of-sample-extension-historical-frozen-scanner-replay-adapter.md`
  - generated OOS-window frozen scanner replay adapter readback (ready, 29/29 months, 7,574 daily decision rows, 3,474 selected candidates)
- `docs/regular-options-out-of-sample-extension-frozen-daily-candidate-decisions.md`
  - generated OOS-window frozen daily candidate decisions readback (ready)
- `docs/regular-options-out-of-sample-extension-frozen-candidate-generation-source-surface.md`
  - generated OOS-window frozen candidate-generation source surface readback (ready, 29 months proven)
- `docs/regular-options-out-of-sample-extension-frozen-candidate-generation-entrypoint.md`
  - generated OOS-window frozen candidate-generation entrypoint readback (ready, 7,574 daily rows)
- `docs/regular-options-out-of-sample-extension-frozen-candidate-generation-engine.md`
  - generated OOS-window candidate-generation engine readback; produces the OOS `selected_candidates.jsonl`; its train/audit-month blockers are main-lane gates that do not scope the OOS evaluation
