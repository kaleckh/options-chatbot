...
- The momentum-continuation research branch currently has 248 historical exact rows, PF 4.0816, and a conservative clustered-bootstrap PF lower bound of 2.24. It remains non-proof and blocked: only 251/353 strategy-eligible rows have synchronized trusted entry/exit quote pairs (71.1%), 102 exact quote repairs remain, no preregistered stress test exists, and no historical row counts toward forward proof.
