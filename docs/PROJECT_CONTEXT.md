...
- The momentum-continuation research branch currently has 264 historical exact rows, PF 2.8554, and a conservative clustered-bootstrap PF lower bound of 1.71. It remains non-proof and blocked: synchronized trusted quote coverage is 270/277 (97.47%) with seven exact quote repairs, but 76 otherwise-eligible rows lack policy exit dates, no preregistered stress test exists, and no historical row counts toward forward proof.
