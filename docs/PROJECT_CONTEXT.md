...
- VRP trusted batches 3123-3124 added 115,417 valid fixed-10:25 put rows with zero rejects/provider errors, but they do not satisfy the frozen 15:55 research engine. The corrected minute-bound surface is blocked at only SPY 3/24, QQQ 4/24, IWM 4/24, and DIA 2/24 months. Native engine readiness requires synchronized 15:55 calls and puts for parity-based spot plus the put spreads; surface readiness is not an economic result.
