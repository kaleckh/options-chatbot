...
- Fresh scan matches / decisions: `5` / `{'blocked': 3, 'clear': 2}`
...
- Guardrail starvation playbooks: `['speculative', 'tracked_winner_primary', 'tracked_winner_observation']`
- Zero-candidate playbooks: `10`
- Leading drops: `[{'count': 114, 'value': 'direction_filter'}, {'count': 112, 'value': 'option_liquidity'}, {'count': 91, 'value': 'momentum'}, {'count': 54, 'value': 'history_or_liquidity'}, {'count': 22, 'value': 'tech_score'}, {'count': 4, 'value': 'direction_score'}, {'count': 0, 'value': 'min_history'}, {'count': 0, 'value': 'signal_index'}]`
...
- Guarded command: status `ready_to_run_primary_next_execution` safe-now `True` next `python scripts/run_ai_commodity_opra_progress.py --force-capture --target-date 2026-05-29` not-before `None`
- Safe to tune filters: `False`
- Top scan drops: `[{'drop_key': 'option_liquidity', 'count': 12, 'example_symbols': ['AA', 'BHP', 'COPX', 'FCX'], 'next_diagnostic_action': 'after_fresh_quotes_recheck_quote_age_then_structural_spread_distance'}, {'drop_key': 'momentum', 'count': 11, 'example_symbols': ['ALB', 'CARR', 'CCJ', 'CEG'], 'next_diagnostic_action': 'review_commodity_momentum_distance_after_exact_replay_unlock'}]`
