...
- Generated at UTC: `2026-06-14T04:02:11Z`
...
| Operator Path | `blocked` | Operator readback is complete, but no paper/live candidates are eligible. | paper_shortlist_release_gate=no_paper_shortlist_candidates; eligible_paper_review_candidates=0; scorecard_status=visible_product_profitability_progress_but_proof_still_blocked; paper_gate_status=paper_only_no_live_release; open_risk_governor_status=open_risk_governor_blocked; open_risk_governor_blockers=["live_exact_negative_open_risk", "live_exact_review_stale_missing_or_non_executable"]; suggested_open_rows=1; suggested_attention_trade_count=1; scheduled_scan_heartbeat_status=fresh; days_since_last_scheduled_scan=0; last_scheduled_scan_host=KAESDEVICE; last_scheduled_scan_commit=6e485e8308a00e145483f7b6613ad90834045a04; ai_commodity_verified=False; ai_commodity_shared_quote_dates=3/100 |
...
| open_risk_governor_blocked_or_missing | block_new_scanner_origin_entries | {"blockers": ["live_exact_negative_open_risk", "live_exact_review_stale_missing_or_non_executable"], "live_exact_negative_ids": [537], "status": "open_risk_governor_blocked"} |
...
| fresh_evidence_loop: `data/forward-tracking/regular_options_fresh_evidence_loop_latest.json` | True | fresh_evidence_loop_readback | 2026-06-14T03:59:32Z |
| open_position_risk: `data/forward-tracking/regular_open_position_risk_latest.json` | True | n/a | 2026-06-14T03:59:38Z |
...
| paper_shortlist: `data/profitability-lab/regular-options-paper-shortlist/latest.json` | True | paper_shortlist_readback | 2026-06-10T16:31:50Z |
