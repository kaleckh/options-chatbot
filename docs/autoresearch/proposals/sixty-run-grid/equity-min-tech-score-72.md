...
`equity-min-tech-score-72`

## Hypothesis

Tightening equity `entry.min_tech_score` to `72.0` may improve replay quality under the fixed matrix without changing fills, watch/block policy, or stability rules.
...
- `python scripts/autoresearch_cycle.py --slug equity-min-tech-score-72 --proposal docs/autoresearch/proposals/sixty-run-grid/equity-min-tech-score-72.md --playbook broad --playbook bullish_momentum --playbook bearish_defensive --compare-to <baseline decomposition run dir>`
