...
class OptionsProfitStateMigrationTests(unittest.TestCase):
    ...
    def test_legacy_symbol_scoped_state_migrates_to_v2_side_state(self):
        ...
        self.assertEqual(incumbents["symbols"]["SPY"]["call"]["canary"]["direction"], "call")
        self.assertEqual(incumbents["symbols"]["SPY"]["put"]["canary"]["direction"], "put")
        ...
        self.assertEqual(status["current_canary"]["SPY"]["call"]["direction"], "call")
        self.assertEqual(status["current_canary"]["SPY"]["put"]["direction"], "put")
