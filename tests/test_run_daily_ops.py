...
class DailyOpsRunnerTests(unittest.TestCase):
    def test_daily_ops_order_is_read_only_and_places_heartbeat_before_gateboard(self) -> None:
        ...
        self.assertEqual(
            ...
            [
                ...
                "materializer_match_rate_stationarity",
    ...
    def test_run_daily_ops_invokes_commands_in_declared_order(self) -> None:
        ...
        self.assertIn([sys.executable, "scripts/build_regular_options_materializer_match_rate_stationarity.py"], calls)
        ...
        self.assertIn("zero-run trigger escalation status", report["boundary"])
