...
LANE_SOURCES: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "artifact": RUNS_DIR / "20260602_104058_sleeve_ticker_iwm_intraday.json",
        "priority": 30,
        "include_in_proof_portfolio": True,
        "notes": "Refreshed exact intraday component after the high-priority repair pass; still expected to overlap the bullish-pullback core.",
    },
    {
    ...
    },
    {
        ...
        "family": "regular_bearish_put_primary",
        "label": "Regular bearish put time-exit probe",
    ...
    },
    {
        ...
        "role": "intraday_rejected_probe",
        "decision": "do_not_promote",
        "artifact": RUNS_DIR / "20260602_110616_tracked_winner_chain_native_qqq_time80_research_intraday.json",
        "priority": 78,
        "include_in_proof_portfolio": False,
        "notes": "Contrarian count-expansion check refreshed after exact quote repair; PF remains below the promotion bar and severe provider no-match coverage debt remains.",
    },
    {
