...
def lane_definitions() -> list[dict[str, Any]]:
    return [
        ...
        },
        {
            ...
            "structure": "XLF call/put debit spreads; KRE observation only.",
            "test": "Keep XLF and KRE separate; graduate KRE only with liquidity evidence.",
            "pass_fail": "Pass only if XLF alone works.",
            "risks": ["Bank headlines.", "KRE liquidity."],
            "data_requirements": ["XLF/KRE option history", "bank breadth", "yield curve proxy"],
            "required_symbols": ["XLF", "KRE"],
            "evaluator": "symbol_data_readiness",
        },
        {
