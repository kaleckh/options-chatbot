...
from supervised_scan import SCAN_PLAYBOOKS, SCAN_PLAYBOOK_FALLBACK_ID, get_scan_playbook, run_supervised_scan
    ...
    *,
    ...
    with _temporary_cohort_context(
        ...
        guardrail_result = run_supervised_scan(
            ...
            playbook_id=str(playbook.get("id") or SCAN_PLAYBOOK_FALLBACK_ID),
...
def main() -> int:
    ...
    parser.add_argument("--playbook", default=SCAN_PLAYBOOK_FALLBACK_ID, help="Scanner playbook to use when none is specified.")
