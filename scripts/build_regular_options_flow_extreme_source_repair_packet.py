...
def build_report(
    *,
    ...
    report = {
        ...
        "point_in_time_flow_extreme_input_status": flow_input.get("status"),
        "flow_extreme_volume_oi_source_rows_status": flow_rows.get("status"),
        ...
        "flow_extreme_ratio_backspread_replay_readiness_status": flow_readiness.get("status"),
