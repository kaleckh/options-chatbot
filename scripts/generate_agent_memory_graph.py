...
NODES: tuple[dict[str, str], ...] = (
    ...
    {
        "id": "agent_control_plane_doc",
        "kind": "doc",
        "path": "docs/agent-control-plane.md",
        "label": "Agent control plane",
        "read_when": "Running CEO worker coordination or using the runtime memory graph.",
        "owner_summary": "Local CEO/worker orchestration workflow and runtime memory graph contract.",
    },
    {
        "id": "agent_control_cli",
        "kind": "script",
        "path": "scripts/agent_control.py",
        "label": "Agent control CLI",
        "read_when": "Creating, claiming, reporting, accepting, remembering, linking, querying, or digesting runtime graph state.",
        "owner_summary": "SQLite WAL plus append-only JSONL task/message/graph control-plane implementation.",
    },
    {
    ...
    {
        "id": "ai_commodity_universe",
        "kind": "generated_artifact",
        "path": "data/ai-commodity-infra/universe.json",
        "label": "AI commodity universe",
        "read_when": "Checking AI commodity proof universe membership.",
        "owner_summary": "Checked AI commodity proof-lane universe artifact.",
    },
    {
...
EDGES: tuple[dict[str, str], ...] = (
    ...
    {"from": "agent_control_plane_doc", "to": "agent_control_cli", "type": "owns", "reason": "The control-plane doc owns the runtime task, message, and graph memory CLI contract."},
    {"from": "agent_control_cli", "to": "agent_control_plane_doc", "type": "implements", "reason": "The CLI implements the local SQLite and JSONL runtime graph described by the doc."},
    {"from": "memory_graph_doc", "to": "agent_control_plane_doc", "type": "does_not_replace", "reason": "The static navigation graph points to the runtime control plane instead of serving as a task ledger."},
    ...
    {"from": "ai_commodity_runner", "to": "ai_commodity_universe", "type": "reads", "reason": "AI commodity runner consumes the checked proof-lane universe."},
...
PLAYBOOKS: tuple[dict[str, Any], ...] = (
    ...
    {
        "id": "ceo_runtime_memory",
        "heading": "If Running CEO/Runtime Agent Memory",
        "summary": "Use the local control plane after startup context when coordinating larger worker sprints.",
        "nodes": ["agents_guide", "project_context", "next_steps", "agent_control_plane_doc", "agent_control_cli", "memory_graph_doc"],
    },
    {
        "id": "ai_commodity",
        "heading": "If Touching AI Commodity",
        "summary": "Treat AI commodity as a separate non-browser proof-first lane.",
        "nodes": ["project_context", "ai_commodity_isolation_doc", "ai_commodity_isolation_json", "next_steps", "ai_commodity_runner", "ai_commodity_universe"],
    },
    {
        "id": "final_closure",
